...
-- Заводятся только те регионы, чьи имена баз известны точно. Заполнитель
-- вместо реального имени здесь стоял раньше и приводил к невнятной ошибке
-- доступа на каждой странице — регион с неизвестной базой лучше добавить
-- вручную на странице «Регионы», когда имя будет известно.
