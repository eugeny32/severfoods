...
// Администратор видит сотрудников ВСЕХ организаций: на одной точке питаются
// люди из разных, и ограничение своей организацией лишало администраторов
// возможности работать. Защита карточек супер-администраторов остаётся —
// см. canAccessEmployeeCard() в src/functions.php.
