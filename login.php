...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!checkLoginRateLimit(10, 10)) {
        ...
        // Неудачная попытка
        // Сам введённый код НЕ логируем: это учётные данные, а опечатка в
        // одном символе означала бы почти верный пароль, сохранённый в
        // журнале открытым текстом навсегда.
        logAction('login_failed', 'Неверный логин администратора');
