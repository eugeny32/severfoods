...
// Запасной путь: основной способ — установка по idle-таймеру ночью, но если она
// почему-то не состоялась (точку выключили, компьютер не простаивал), скачанное
// обновление поставится при ближайшем настоящем выходе. Раньше здесь было
// false, и единственная неудачная ночная попытка означала, что версия так и не
// установится до следующей ночи.
