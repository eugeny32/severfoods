 ...
 * — для всех типов, включая ночное питание:
 ...
 *  - тип 'night' сохраняется как есть: ночное питание — полноценный приём
 *    пищи наравне с остальными (раньше он приводился к завтраку/ужину);
...
try {
    ...
    foreach ($rows as $r) {
        ...
        // Ночное окно даёт тип 'night' как есть: это полноценный приём пищи.
